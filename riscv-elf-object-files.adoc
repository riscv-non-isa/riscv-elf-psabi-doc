...
_Generic System V Application Binary Interface_ xref:elf-bib.adoc#gabi[]
...
_RISC-V Assembly Programmer's Manual_ xref:elf-bib.adoc#rv-asm[].
...
See _ELF Handling For Thread-Local Storage_ xref:elf-bib.adoc#tls[].
...
whcih defined in
_The RISC-V Instruction Set Manual, Volume I: User-Level ISA, Document_ xref:elf-bib.adoc#riscv-unpriv[]
