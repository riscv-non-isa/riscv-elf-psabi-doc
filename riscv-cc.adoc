...
=== Capability Register Convention
...
[[abi-il32pc64]]
IL32PC64:: Integer and capability calling convention only, hardware floating-point calling convention is not used
...
| All other types        | See ILP32* ABIs | See LP64* ABIs
|===
